...
//ACD1100初始化
bool ACD1100::begin(I2C* wirePort, HardwareSerial* serialPort) {
    if (_commMode == COMM_I2C) {
        _i2cPort = wirePort;
        // I2C 已在 main.cpp 中初始化，无需重复调用 begin()
    } else {
        // UART模式
...
std::string ACD1100::getSoftwareVersion() {
...
std::string ACD1100::getSensorID() {
